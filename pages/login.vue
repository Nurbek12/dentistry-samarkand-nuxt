    ...
    <div class="h-[100vh] flex items-center justify-center px-2">
        <div class="max-w-[420px] w-full p-4 border rounded overflow-hidden">
            <form @submit.prevent="login" class="w-full">
                <h1 class="text-xl font-medium text-center text-teal-600">Войти в систему</h1>
                ...
                <div class="w-full mt-4">
                    <button type="submit" :disabled="loading"
                        class="disabled:bg-teal-900 bg-teal-600 rounded hover:bg-teal-500 active:bg-teal-400 text-white px-3 py-2 w-full">Отправить</button>
                </div>
            </form>
        </div>
    </div>
